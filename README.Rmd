...
***
Another tool I have not yet tried yet (as I'm a `ctb` to the `lockedata/starters` package) but looks promising is [`rrtools`](https://github.com/benmarwick/rrtools). It provides a convenient starting point for writing a journal article, report, or thesis.

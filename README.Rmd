...
* Scripts should be kept in the `R` folder and you should have one script to run eveything if possible in the main directory 
...
***
Temple Lang and Gentleman (2007) advance the proposal for using the R package structure as a "Research Compendium," an idea that has since caught on with many others.
